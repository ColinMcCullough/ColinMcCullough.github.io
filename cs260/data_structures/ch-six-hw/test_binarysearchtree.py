...
class BinaryTreeTests(unittest.TestCase):
    ...
    def testFindSucc(self):
        ...
        assert x.root.leftChild.leftChild.successor.key == 6
        assert x.root.leftChild.rightChild.findSuccessor().key == 9
        assert x.root.leftChild.rightChild.successor.key == 9
        assert x.root.leftChild.rightChild.rightChild.findSuccessor().key == 10
        assert x.root.leftChild.rightChild.rightChild.successor.key == 10
        assert x.root.rightChild.findSuccessor() == None
        assert x.root.rightChild.successor == None

    def testNonRecursiveFindSucc(self):
        print('testing findSucc')
        x = BinarySearchTree()
        x.put(10,'a')
        x.put(15,'b')
        ...
        x.put(8,'e')
        x.put(9,'f')
        assert x.root.leftChild.leftChild.nonrecfindsuccessor().key == 6
        assert x.root.leftChild.rightChild.nonrecfindsuccessor().key == 9
        assert x.root.leftChild.rightChild.rightChild.nonrecfindsuccessor().key == 10

    def test_nonrecinorder(self):
        x = BinarySearchTree()
        x.put(10,'a')
        x.put(15,'b')
        x.put(6,'c')
    ...
    def testDelete(self):
        ...
        assert self.bst.root.leftChild.successor.key == 30
        assert self.bst.root.leftChild.successor == self.bst.root.leftChild.rightChild
        assert self.bst.root.leftChild.leftChild.successor.key == 15
        ...
        assert self.bst.root.leftChild.successor.key == 45
        assert self.bst.root.leftChild.rightChild.key == 45
        assert self.bst.root.leftChild.rightChild.successor.key == 50
        ...
        assert self.bst.get(30) == 'd'
        assert self.bst.root.successor.key == 85
        ...
        assert self.bst.root.leftChild.rightChild.key == 45
        assert self.bst.root.leftChild.rightChild.successor.key == 85
        ...
        self.bst.delete(45)
        assert self.bst.root.leftChild.key == 30
        assert self.bst.root.leftChild.successor.key == 85
        self.bst.delete(85)
        assert self.bst.root.key == 30
        assert self.bst.root.successor == None
        assert self.bst.root.leftChild.successor.key == 30
        assert self.bst.root.leftChild.successor.successor == None
